...
const ChooseTeams = (props) => {
	...
	const teamsInTeamsTable = () => {
		...
		const secondGroup = teamsInTable
		...
		const fourthGroup = teamsInTable
			.filter((item) => item.group === 4)
			.map((team) => (
				<li key={team.id} onClick={handleTeamClick}>
					<div className={`team-in-basket ${team.selected}`}>
						<img src={team.img} alt={team.team} className={team.class}></img>
		...
		return (
			<>
				...
				>
					<h2 style={{ fontSize: '36px', color: 'white', minWidth: '120px' }}>Koszyk 1</h2>
					{firstGroup}
				</div>
				<div style={{ backgroundColor: 'rgba(0,0,0,0.7)', width: '100%', height: '1px' }} />
				<div
					style={{
						display: 'flex',
						alignItems: 'center',
				...
				>
					<h2 style={{ fontSize: '36px', color: 'white', minWidth: '120px' }}>Koszyk 2</h2>
					{secondGroup}
				</div>
				<div style={{ backgroundColor: 'rgba(0,0,0,0.7)', width: '100%', height: '1px' }} />
				...
				>
					<h2 style={{ fontSize: '36px', color: 'white', minWidth: '120px' }}>Koszyk 3</h2>
					{thirdGroup}
				</div>
				<div style={{ backgroundColor: 'rgba(0,0,0,0.7)', width: '100%', height: '1px' }} />
				...
				>
					<h2 style={{ fontSize: '36px', color: 'white', minWidth: '120px' }}>Koszyk 4</h2>
					{fourthGroup}
				</div>
			</>
		);
	...
	return (
		<Wrapper>
			<div className={'dashboard'}>
				...
				<AmountOfTeams small>Ilość wybranych drużyn: {teamsInBasket.length}</AmountOfTeams>
				<ManageButtons>
